// Script to fetch real BIOCON.NS stock data from Yahoo Finance API
const fs = require('fs');
const https = require('https');

// Use actual historical dates (not relative to simulated environment date)
// End date: Current date
const endDate = new Date();
const endTimestamp = Math.floor(endDate.getTime() / 1000);

// Start date: Approximately 18 months ago to ensure we get at least 250 trading days
